...
public class StockTimeSeries {
    ...
    public static String getTime_Series_Daily(Symbol symbol) {
        return getTime_Series_Daily(symbol, Outputsize.COMPACT, Datatype.JSON);
    }

    public static String getTime_Series_Daily(Symbol symbol, Outputsize outputsize) {
        return getTime_Series_Daily(symbol, outputsize, Datatype.JSON);
    }

    public static String getTime_Series_Daily(Symbol symbol, Datatype datatype) {
        return getTime_Series_Daily(symbol, Outputsize.COMPACT, datatype);
    }

    public static String getTime_Series_Daily(Symbol symbol, Outputsize outputsize, Datatype datatype) {
        String requestString = RequestStringBuilder(Function.TIME_SERIES_DAILY, symbol, outputsize, datatype);
        return VantageApiRequests.RequestData(requestString);
    }


    public static String getTime_Series_Weekly(Symbol symbol) {
        return getTime_Series_Weekly(symbol, Datatype.JSON);
    }

    public static String getTime_Series_Weekly(Symbol symbol, Datatype datatype) {
        String requestString = RequestStringBuilder(Function.TIME_SERIES_WEEKLY, symbol, datatype);
        return VantageApiRequests.RequestData(requestString);
    }


    public static String getTime_Series_Monthly(Symbol symbol) {
        return getTime_Series_Monthly(symbol, Datatype.JSON);
    }

    public static String getTime_Series_Monthly(Symbol symbol, Datatype datatype) {
